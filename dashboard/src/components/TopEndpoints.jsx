        ...
        <div className={styles.headerContainer}>
          <div className={styles.headerInfo}>
            ...
            <div>
              <CardTitle>Top Endpoints</CardTitle>
              <CardDescription>
                Most active API endpoints by hit count
              </CardDescription>
            </div>
          </div>
              ...
              <div className={styles.endpointContent}>
                <div className={styles.endpointInfo}>
                  <div className={styles.topRow}>
                    <div
                      className={`${styles.rankBadge} ${getRankColor(index)}`}
                    >
                      #{index + 1}
                    </div>
                    ...
                    <Badge
                      variant="outline"
                      className={`${styles.methodBadge} ${getMethodColor(endpoint.method)}`}
                    >
                      {endpoint.method}
                    </Badge>

                    <Badge variant="secondary" className={styles.serviceBadge}>
                  ...
                  <div className={styles.statsGrid}>
                    ...
                    <div className={styles.statItem}>
                      <div
                        className={`${styles.statIcon} ${styles.statIconRed}`}
                      >
                      ...
                      <div>
                        ...
                        <p
                          className={`${styles.statValue} ${styles.errorRate}`}
                        >
                          {endpoint.errorRate}%
                        </p>
                      </div>
